...
export const SET_GRADIENT_PAW_BUTTON_FAB_COLOR = 'SET_GRADIENT_PAW_BUTTON_FAB_COLOR';
...
export const setGradientPawButtonFabColor = (color = white) => ({
  type: SET_GRADIENT_PAW_BUTTON_FAB_COLOR,
  color,
});
